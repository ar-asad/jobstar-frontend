...
const Addjobs = () => {
    return (
        <div className="bg-white mt-8 lg:mt-20 mx-5 lg:mx-14 p-8 mb-20 shadow-md hover:shadow-xl transition duration-500">
            <h2 className="lg:text-2xl text-3xl mb-6 text-black">Add Job</h2>
